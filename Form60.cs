...
namespace WindowsFormsApplication1
{
    public partial class Form60 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query1 = "UPDATE `bénéficiaire` SET `type bénéficiaire`='" + textBox1.Text + "'WHERE `ID bénéficiaire`='" + comboBox1.Text + "'";
            connection.Open();
        ...
        {
            connection.Open();
            string query = "SELECT * FROM `bénéficiaire` WHERE  `ID bénéficiaire`='" + comboBox1.Text + "' ";

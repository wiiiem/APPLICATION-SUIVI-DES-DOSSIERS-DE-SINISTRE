...
namespace WindowsFormsApplication1
{
    public partial class Form32 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query1 = "UPDATE `territoire` SET `Nom_territoire`='" + textBox1.Text + "' WHERE `ID territoire`='" + comboBox1.Text + "'";
            connection.Open();
        ...
        {
            connection.Open();
            string query = "SELECT * FROM `territoire` WHERE  `ID territoire`='" + comboBox1.Text + "' ";
        ...
        private void Form32_Load(object sender, EventArgs e)
        {
            ...
            {
                connection.Open();
                string query = "SELECT * FROM `territoire` ";
                MySqlCommand cmd = new MySqlCommand(query, connection);

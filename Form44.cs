...
namespace WindowsFormsApplication1
{
    public partial class Form44 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query1 = "UPDATE `procédure` SET `type de procédure`='" + textBox1.Text + "' WHERE `ID procédure`='" + comboBox1.Text + "'";
            connection.Open();
        ...
        {
            connection.Open();
            string query = "SELECT * FROM `procédure` WHERE  `ID procédure`='" + comboBox1.Text + "' ";
